...
replace (
	...
	github.com/Mirantis/cri-dockerd => github.com/k3s-io/cri-dockerd v0.3.15-k3s1.33.0 // v1.32.0-k3s1
	...
	github.com/containerd/containerd/v2 => github.com/k3s-io/containerd/v2 v2.0.4-k3s4
