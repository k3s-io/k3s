...
replace (
	...
	github.com/spegel-org/spegel => github.com/k3s-io/spegel v0.0.30-k3s1.32
	...
	k8s.io/externaljwt => github.com/k3s-io/kubernetes/staging/src/k8s.io/externaljwt v1.32.1-k3s1
