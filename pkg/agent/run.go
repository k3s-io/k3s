...
func configureNode(ctx context.Context, nodeConfig *daemonconfig.Node, coreClient kubernetes.Interface) error {
	...
	condition := func(ev watch.Event) (bool, error) {
		...
		if err := patch.ApplyTo(ctx, nodes, nodeConfig.AgentConfig.NodeName); err != nil {
...
func updateMutableLabels(agentConfig *daemonconfig.Agent, patch *util.PatchList[*v1.Node]) {
...
func updateLegacyAddressLabels(agentConfig *daemonconfig.Agent, patch *util.PatchList[*v1.Node], node *v1.Node) {
...
func removeLegacyAddressLabels(patch *util.PatchList[*v1.Node], node *v1.Node) {
...
func updateAddressAnnotations(agentConfig *daemonconfig.Agent, patch *util.PatchList[*v1.Node], node *v1.Node) {
...
func removeAddressAnnotations(patch *util.PatchList[*v1.Node], node *v1.Node) {
