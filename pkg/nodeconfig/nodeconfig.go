...
func SetNodeConfigAnnotations(nodeConfig *config.Node, patch *util.PatchList[*corev1.Node], node *corev1.Node) error {
...
func SetNodeConfigLabels(nodeConfig *config.Node, patch *util.PatchList[*corev1.Node], node *corev1.Node) error {
