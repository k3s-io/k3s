...
type Executor interface {
	Bootstrap(ctx context.Context, nodeConfig *daemonconfig.Node, cfg cmds.Agent, apiServerReady <-chan struct{}) error
...
func Bootstrap(ctx context.Context, nodeConfig *daemonconfig.Node, cfg cmds.Agent, apiReady <-chan struct{}) error {
	return executor.Bootstrap(ctx, nodeConfig, cfg, apiReady)
}
